...
extract_and_classify(QF, jpeg_cover_dir, ori_stego_dir, params, payload);
...
function extract_and_classify(QF, jpeg_cover_dir, stego_dir, params, payload)
    ...
    cover_features_path = sprintf('/data/lml/jpeg_test/dctr_cover_features_ln%d_QF%d.mat',params.listNum, QF);
    if params.start == 0
