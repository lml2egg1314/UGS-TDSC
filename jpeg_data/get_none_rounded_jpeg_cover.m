...
quality = QFs(i);
input_jpeg_dir_tpl = '/data/lml/jpeg_test/BB-cover-resample-256-jpeg-%d/';
output_jpeg_dir_tpl = '/data/lml/jpeg_test/BB-cover-resample-256-jpeg-%d-non-rounded/';

input_jpeg_dir = sprintf(input_jpeg_dir_tpl,  quality);
output_jpeg_dir = sprintf(output_jpeg_dir_tpl,  quality);
