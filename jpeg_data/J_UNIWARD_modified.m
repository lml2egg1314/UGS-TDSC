function [S_STRUCT,rhoP1, rhoM1, prob, pChangeP1, pChangeM1] = J_UNIWARD_modified(coverPath, payload)
...
[S_COEFFS, prob, pChangeP1, pChangeM1] = EmbeddingSimulator(C_COEFFS, rhoP1, rhoM1, round(payload * nzAC));

S_STRUCT = C_STRUCT;
S_STRUCT.coef_arrays{1} = S_COEFFS;

function [y, prob_map, pChangeP1, pChangeM1] = EmbeddingSimulator(x, rhoP1, rhoM1, m)
