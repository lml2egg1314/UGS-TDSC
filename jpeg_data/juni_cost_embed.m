function flag = juni_cost_embed(payload, QF)
    %%
...
%     end
    ...
    parfor index = 1:20000
        ...
        % end
        BB_path = [BB_dir, '/', num2str(index), '.jpg'];
        ...
        [S_COEFFS, prob, pP1, pM1] = EmbeddingSimulator(C_COEFFS, rhoP1, rhoM1, round(payload * nzAC),0);
